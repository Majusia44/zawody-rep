...
<div id="home">
    ...
    <script>
        ...
        function generujFormularz(iloscPol) {
            ...
            for (let i = 1; i <= iloscPol; i++) { 
                ...
                formularz += '<input type="number" id="pole'+ i +'" name="pole'+ i +'" oninput="obliczSume()">';
                formularz += '<select id="operation' + i +'" name="operation"> <option value= 20>X</option><option value= 10>/</option><option value= 0>none</option></select><br>'
            }
        ...
        function obliczSume() {
            ...
            for (let i = 1; i <= iloscPol; i++) { 
                ...
                let selectValue = document.getElementById('operation' + i).value;
                console.log(selectValue);
                if (!isNaN(poleValue)) { 
                    suma += poleValue * selectValue;
    ...
    <div id="pkt">
    <h3>Punktacja:</h3>
    <p>X to strzał wewnętrzny który daje 20 punktów</p>
